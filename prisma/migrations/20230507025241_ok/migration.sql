/*
  ...
  - You are about to drop the column `row` on the `Pokemons` table. All the data in the column will be lost.
  - Added the required column `id` to the `Pokemons` table without a default value. This is not possible if the table is not empty.
